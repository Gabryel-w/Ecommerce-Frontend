        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-sm text-gray-600 hover:text-orange-500">Informações sobre a Nest Store</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/sell" className="text-sm text-gray-600 hover:text-orange-500">Vender na Nest Store</Link></li>
        ...
        <div className="border-t border-gray-300 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <p className="text-xs text-gray-500">© 2025 NestStore.com, Inc. ou suas afiliadas</p>
            </div>
          </div>
        </div>
      </div>
